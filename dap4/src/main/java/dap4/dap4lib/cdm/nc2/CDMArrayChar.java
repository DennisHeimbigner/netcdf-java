 ...
 * Data storage is with 1D java array of Char.
 * <p/>
 * issues: what should we do if a conversion loses accuracy? nothing ? Exception ?
 *
 * @author Heimbigner
 */
public class CDMArrayChar extends ArrayChar implements CDMArray {
   ...
   */
  public CDMArrayChar(CDMArrayAtomic array) {
   ...
   */
  CDMArrayChar(Index ima, CDMArrayAtomic array) {
    super(ima,new char[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayChar(index,this.array);
  }
  ...
  public char get(Index i) {
    return (char)(Character)array.getObject(i);
  }
