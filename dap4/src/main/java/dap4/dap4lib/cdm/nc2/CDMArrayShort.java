 ...
 * Data storage is with 1D java array of Short.
 * <p/>
 ...
 * @see Array
 */
public class CDMArrayShort extends ArrayShort implements CDMArray {
   ...
   */
  public CDMArrayShort(CDMArrayAtomic array) {
   ...
   */
  CDMArrayShort(Index ima, CDMArrayAtomic array) {
    super(ima,  CDMArray.signify(array), new short[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayShort(index,this.array);
  }
  ...
  public short get(Index i) {
    return (short)(Short)array.getObject(i);
  }
