 ...
 * Data storage is with 1D java array of Long.
 * <p/>
 * issues: what should we do if a conversion loses accuracy? nothing ? Exception ?
 *
 * @author Heimbigner
 */
public class CDMArrayLong extends ArrayLong implements CDMArray {
   ...
   */
  public CDMArrayLong(CDMArrayAtomic array) {
   ...
   */
  CDMArrayLong(Index ima, CDMArrayAtomic array) {
    super(ima, CDMArray.signify(array), new long[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayLong(index,this.array);
  }
  ...
  public long get(Index i) {
    return (long)(Long)array.getObject(i);
  }
