...
/**
 * Concrete implementation of Array specialized for Double.
 * Data storage is with 1D java array of Double.
 * <p/>
 * issues: what should we do if a conversion loses accuracy? nothing ? Exception ?
 *
 * @author Heimbigner
 */
public class CDMArrayDouble extends ArrayDouble implements CDMArray {
   ...
   */
  public CDMArrayDouble(CDMArrayAtomic array) {
   ...
   */
  CDMArrayDouble(Index ima, CDMArrayAtomic array) {
    super(ima, new double[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayDouble(index,this.array);
  }
  ...
  public double get(Index i) {
    return (double)(Double)array.getObject(i);
  }
