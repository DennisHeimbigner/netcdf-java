...
/**
 * Concrete implementation of Array specialized for Int.
 * Data storage is with 1D java array of Int.
 * <p/>
 * issues: what should we do if a conversion loses accuracy? nothing ? Exception ?
 *
 * @author Heimbigner
 */
public class CDMArrayInt extends ArrayInt implements CDMArray {
   ...
   */
  public CDMArrayInt(CDMArrayAtomic array) {
          super(CDMArray.dimset2shape(array),CDMArray.signify(array));
    this.array = array;
  }
   ...
   */
  CDMArrayInt(Index ima, CDMArrayAtomic array) {
    super(ima, CDMArray.signify(array), new int[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayInt(index,this.array);
  }
  ...
  public int get(Index i) {
    return (int)(Integer)array.getObject(i);
  }
