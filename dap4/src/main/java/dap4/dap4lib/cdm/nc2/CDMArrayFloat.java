...
/**
 * Concrete implementation of Array specialized for Float.
 * Data storage is with 1D java array of Float.
 * <p/>
 * issues: what should we do if a conversion loses accuracy? nothing ? Exception ?
 *
 * @author Heimbigner
 */
public class CDMArrayFloat extends ArrayFloat implements CDMArray {
   ...
   */
  public CDMArrayFloat(CDMArrayAtomic array) {
   ...
   */
  CDMArrayFloat(Index ima, CDMArrayAtomic array) {
    super(ima, new float[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayFloat(index,this.array);
  }
  ...
  public float get(Index i) {
    return (float)(Float)array.getObject(i);
  }
