 ...
 * Data storage is with 1D java array of Byte.
 * <p/>
 * issues: what should we do if a conversion loses accuracy? nothing ? Exception ?
 *
 * @author Heimbigner
 */
public class CDMArrayByte extends ArrayByte implements CDMArray {
   ...
   */
  public CDMArrayByte(CDMArrayAtomic array) {
   ...
   */
  CDMArrayByte(Index ima, CDMArrayAtomic array) {
    super(ima, CDMArray.signify(array), new byte[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayByte(index,this.array);
  }
  ...
  public byte get(Index i) {
    return (byte)(Byte)array.getObject(i);
  }
