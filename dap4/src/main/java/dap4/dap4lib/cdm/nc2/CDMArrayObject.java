...
/**
 * Concrete implementation of Array specialized for Object.
 * Data storage is with 1D java array of Object.
 * <p/>
 * issues: what should we do if a conversion loses accuracy? nothing ? Exception ?
 *
 * @author Heimbigner
 */
public class CDMArrayObject extends ArrayObject implements CDMArray {
   ...
   */
  public CDMArrayObject(CDMArrayAtomic array) {
    super(CDMArray.dap2cdmtype(array), CDMArray.cdmclass(array), false, CDMArray.dimset2shape(array), new Object[0]);
    this.array = array;
  }
   ...
   */
  CDMArrayObject(Index ima, CDMArrayAtomic array) {
    super(CDMArray.dap2cdmtype(array), CDMArray.cdmclass(array), false, ima, new Object[0]);
    this.array = array;
  }
  ...
  protected Array createView(Index index) {
    return new CDMArrayObject(index,this.array);
  }
