...
abstract class CEBisonParser
{
  ...
  public enum SymbolKind
  {
    ...
    private static final SymbolKind[] values_ = {
      ...
      SymbolKind.S_dimredeflist,
      SymbolKind.S_clauselist,
      SymbolKind.S_clause,
      SymbolKind.S_projection,
      SymbolKind.S_segmenttree,
      SymbolKind.S_segmentforest,
      SymbolKind.S_segment,
      SymbolKind.S_slicelist,
      SymbolKind.S_slice,
      SymbolKind.S_subslicelist,
      SymbolKind.S_subslice,
      SymbolKind.S_extent,
      SymbolKind.S_selection,
      SymbolKind.S_filter,
      SymbolKind.S_predicate,
      SymbolKind.S_relop,
      SymbolKind.S_eqop,
      SymbolKind.S_primary,
      SymbolKind.S_dimredef,
      SymbolKind.S_fieldname,
  ...
  "LONG", "DOUBLE", "BOOLEAN", "','", "NOT", "';'", "'.'", "'{'", "'}'",
  "'['", "']'", "':'", "'|'", "'!'", "'<'", "'='", "'>'", "'~'", "'('",
  "')'", "$accept", "constraint", "dimredeflist", "clauselist", "clause",
  "projection", "segmenttree", "segmentforest", "segment", "slicelist",
  "slice", "subslicelist", "subslice", "extent", "selection", "filter",
  "predicate", "relop", "eqop", "primary", "dimredef", "fieldname",
  "constant", null
    };
  }
  ...
  if (yyn == 26)
    /* "ce.y":188  */
            {yyval=subslice(3,((String)(yystack.valueAt (4))),((String)(yystack.valueAt (0))),((String)(yystack.valueAt (2))));};
  break;
  ...
  if (yyn == 34)
    /* "ce.y":216  */
            {yyval=predicate(((CEAST.Operator)(yystack.valueAt (1))),((CEAST)(yystack.valueAt (2))),((CEAST)(yystack.valueAt (0))));};
  break;
  ...
  if (yyn == 35)
    /* "ce.y":218  */
            {yyval=predicaterange(((CEAST.Operator)(yystack.valueAt (3))),((CEAST.Operator)(yystack.valueAt (1))),((CEAST)(yystack.valueAt (4))),((CEAST)(yystack.valueAt (2))),((CEAST)(yystack.valueAt (0))));};
  break;
  ...
  if (yyn == 47)
    /* "ce.y":245  */
            {yyval=null; dimredef(((String)(yystack.valueAt (2))),((Slice)(yystack.valueAt (0))));};
  break;
