...
public interface Dap4ManifestIF {
  ...
  static public final String[][] dap4_manifest = {{"test_atomic_array"}, {"test_atomic_types"}, {"test_enum_1"},
      {"test_enum_2"}, {"test_enum_3"}, {"test_enum_array"}, {"test_fill"}, {"test_fill_2"}, {"test_groups1"},
      {"test_misc1"}, {"test_one_var"}, {"test_one_vararray"}, {"test_opaque"}, {"test_opaque_array"}, {"test_struct1"},
